...
function InitialPage() {
        ...
        <div className="flex justify-around items-center gap-30">
          <div className="flex gap-5 flex-col justify-start align-start text-black ml-4">
            ...
            <h4 className="text-2xl font-semibold">
              Browse our collection, find what you love, and enjoy a smooth
              shopping experience from start to finish.
            </h4>
            <div>
              <button className="hover:bg-red-700  text-xl border-2 border-solid py-3 px-5 rounded-2">
                Shop Now
              </button>
            </div>
          </div>
          <img
            src="https://res.cloudinary.com/dppznstlh/image/upload/v1733338071/cart_2_pmbksp.png"
            className="initial-image"
            alt="POSETRA Home PAGE"
          />
        </div>
      </div>
    );
  ...
  return (
    <div
      className="container g-[40px] p-5 flex justify-around items-center min-h-[60vh] bg-[#fff]
    "
      // bg-gradient-to-r from-[#86d3e3] to-[#506bf2]
    >
      ...
      {!isLoggedIn && (
        <div className="flex flex-col justify-around items-center text-center h-[80vh] mr-40 px-4 py-8">
          <div className="signup-button bg-[#fff] px-4 py-6 text-[#002C54]-600 rounded-md">
            <h3 className="text-3xl mb-2 font-play font-semibold">
